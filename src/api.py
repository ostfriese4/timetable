...
version = "4.2.0"
releaseNotes = "        <ul>\n          <li>improved external pages</li>\n          <li>fixed deleting of profiles</li>\n          <li>hide unavailable features</li>\n          <li>fixed crash if WebUntis is down @Felitendo</li>\n          <li>redesigned timetable @Felitendo</li>\n          <li>show the substitution text of a lesson @Felitendo</li>\n          <li>show overlapping lessons next to each other @Felitendo</li>\n        </ul>\n"#"""
